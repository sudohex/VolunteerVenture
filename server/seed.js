...
const services = [
  ...
  new Service({
    ...
    category: categories[0]._id,
    location: locations[0]._id,
    expireDate: new Date("2023-11-23"),
    status: "online",
  }),
  new Service({
  ...
  new Service({
    ...
    category: categories[1]._id,
    location: locations[1]._id,
    expireDate: new Date("2023-10-19"),
    status: "online",
  }),
  new Service({
  ...
  new Service({
    ...
    category: categories[1]._id,
    location: locations[1]._id,
    expireDate: new Date("2023-11-03"),
    status: "online",
  }),
  new Service({
    serviceName: "Massage",
  ...
  new Service({
    ...
    category: categories[1]._id,
    location: locations[1]._id,
    expireDate: new Date("2023-12-12"),
    status: "online",
  }),

  // Hair & Beauty - Rockhampton
  new Service({
    serviceName: "Waxing",
    description: "Smooth skin with professional waxing services.",
    category: categories[1]._id,
  ...
  new Service({
    ...
    location: locations[1]._id,
    expireDate: new Date("2023-10-27"),
    status: "online",
  }),
  ...
  new Service({
    ...
    location: locations[2]._id,
    expireDate: new Date("2023-12-16"),
    status: "online",
  }),
  new Service({
  ...
  new Service({
    serviceName: "Headache Treatment",
  ...
  new Service({
    ...
    description: "Customised strength training programs.",
    category: categories[5]._id,
    location: locations[2]._id,
  ...
  new Service({
    ...
    category: categories[5]._id,
    location: locations[2]._id,
    expireDate: new Date("2023-12-05"),
    status: "online",
  }),
  ...
  new Service({
    ...
    category: categories[6]._id,
    location: locations[3]._id,
    expireDate: new Date("2023-12-23"),
    status: "online",
  }),
  new Service({
    ...
    category: categories[6]._id,
    location: locations[3]._id,
    expireDate: new Date("2023-12-11"),
    status: "online",
  }),
  new Service({
    serviceName: "Scaling and Clean",
    description: "Deep cleaning of teeth and gums.",
    category: categories[6]._id,
    location: locations[3]._id,
    expireDate: new Date("2023-11-19"),
    status: "online",
  }),
  new Service({
    ...
    category: categories[6]._id,
    location: locations[3]._id,
    expireDate: new Date("2023-11-14"),
    status: "online",
  }),
  new Service({
    ...
    category: categories[6]._id,
    location: locations[3]._id,
    expireDate: new Date("2023-11-28"),
    status: "online",
  }),
  ...
  new Service({
    ...
    location: locations[3]._id,
    expireDate: new Date("2023-10-28"),
    status: "online",
  }),
  new Service({
  ...
  new Service({
    ...
    location: locations[1]._id,
    expireDate: new Date("2023-12-18"),
    status: "online",
  }),
  new Service({
    ...
    category: categories[8]._id,
    location: locations[0]._id,
    expireDate: new Date("2023-11-08"),
    status: "online",
  }),
  new Service({
    ...
    category: categories[8]._id,
    location: locations[3]._id,
    expireDate: new Date("2023-09-20"),
    status: "online",
  }),
  new Service({
